...
/**
  ...
  */
case class Point(pid: String, label: String, var value: Array[Float],weight: Float = 1.0f) extends Comparable[Point]{
  ...
  /**
    ...
    */
  lazy val normalizedValue: Array[Float] = value / weight

  override def compareTo(o: Point): Int = pid.compareTo(o.pid)
